...
export default {
  ...
  data () {
    ...
    return{
      name: '作成物',
      out:[
      {title:'でじふぁーむ。',text: 'これは学生の提出物を管理するWebベースのアプリケーションです。',prog:'HTML CSS Javascript Python3 postgre'},
      {title:'チャリ共',text:'これは自転車を使っているユーザ向けのマップアプリです。',prog:'HTML CSS Javascript PHP MySQL'}
    ]
    }
  }
}
